...
//Brief: Here we want functions to draw various shapes and planes
//I have added the ability to draw billboards that face the camera on its X rotation
//==============================================
...
public:
	...
	// Adds a billboard (a quad that always faces the camera
	static void billboard(glm::vec3& a_position, glm::vec4& a_colour, float& a_size, glm::mat4& a_camera);
