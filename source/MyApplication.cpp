...
bool MyApplication::onCreate(int a_argc, char* a_argv[])
{
	...
	//Gizmos::create();
	//need just 45lines for sqaure on floor and XYZ, then tris need to be double our particle count
	Gizmos::create(64, 65536 * 2);
	...
	//create new emitter       position   particle size minmaxAvgLife, end colour                          start colour
	emitter = new Emitter(glm::vec3(0,0,0), 0.1f, 128, 2.f, 4.f, glm::vec4(0.1, 0.1, 0.1, 0.5), glm::vec4(0.5, 0.5, 0.5, 0.1));
